...
void engineprediction::restore_netvars()
{
	...
	punch_delta = g_ctx.local()->m_aimPunchAngle() - data->m_aimPunchAngle;
	punch_vel_delta = g_ctx.local()->m_aimPunchAngleVel() - data->m_aimPunchAngleVel;
	view_delta = g_ctx.local()->m_viewPunchAngle() - data->m_viewPunchAngle;
	modifier_delta = g_ctx.local()->m_flVelocityModifier() - data->m_velocity_modifier;
	offset_delta = g_ctx.local()->m_vecViewOffset() - data->m_vecViewOffset;
