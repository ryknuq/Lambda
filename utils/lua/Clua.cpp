...
void c_lua::initialize()
{
	...
	ui[crypt_str("nextline")] = ns_menu::next_line;
	ui[crypt_str("checkbox")] = ns_menu::add_check_box;
	ui[crypt_str("combobox")] = ns_menu::add_combo_box;
	ui[crypt_str("sliderint")] = ns_menu::add_slider_int;
	ui[crypt_str("sliderfloat")] = ns_menu::add_slider_float;
	ui[crypt_str("colorpicker")] = ns_menu::add_color_picker;
	ui[crypt_str("get_bool")] = ns_menu::get_bool;
	ui[crypt_str("get_int")] = ns_menu::get_int;
	ui[crypt_str("get_float")] = ns_menu::get_float;
	ui[crypt_str("get_color")] = ns_menu::get_color;
	ui[crypt_str("get_key_bind_state")] = ns_menu::get_key_bind_state;
	ui[crypt_str("get_key_bind_mode")] = ns_menu::get_key_bind_mode;
	ui[crypt_str("set_bool")] = ns_menu::set_bool;
	ui[crypt_str("set_int")] = ns_menu::set_int;
	...
	game[crypt_str("get_screen_width")] = ns_engine::get_screen_width;
	game[crypt_str("get_screen_height")] = ns_engine::get_screen_height;
	//game[crypt_str("get_level_name")] = ns_engine::get_level_name;
//	game[crypt_str("get_level_name_short")] = ns_engine::get_level_name_short;
	//game[crypt_str("get_local_player_index")] = ns_engine::get_local_player_index;
	//game[crypt_str("get_map_group_name")] = ns_engine::get_map_group_name;
	//game[crypt_str("get_player_for_user_id")] = ns_engine::get_player_for_user_id;
//game[crypt_str("get_player_info")] = ns_engine::get_player_info;
	//game[crypt_str("get_view_angles")] = ns_engine::get_view_angles;
	game[crypt_str("is_connected")] = ns_engine::is_connected;
	game[crypt_str("is_hltv")] = ns_engine::is_hltv;
	game[crypt_str("is_in_game")] = ns_engine::is_in_game;
	//game[crypt_str("is_paused")] = ns_engine::is_paused;
	//game[crypt_str("is_playing_demo")] = ns_engine::is_playing_demo;
	//game[crypt_str("is_recording_demo")] = ns_engine::is_recording_demo;
	//game[crypt_str("is_taking_screenshot")] = ns_engine::is_taking_screenshot;
	//game[crypt_str("set_view_angles")] = ns_engine::set_view_angles;
