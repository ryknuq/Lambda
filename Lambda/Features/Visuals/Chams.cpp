...
void CChams::LoadChams() {
	...
	baseMaterials[MaterialType::Default] = MaterialSystem->CreateMaterial("lambda/default", keyval_def);
	...
	baseMaterials[MaterialType::Flat] = MaterialSystem->CreateMaterial("lambda/flat", keyval_flat);
	...
	baseMaterials[MaterialType::Glow] = MaterialSystem->CreateMaterial("lambda/glow", keyval_glow);
