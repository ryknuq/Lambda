...
#define ENGINE_DLL				crypt_str("engine.dll")
#define CLIENT_DLL				crypt_str("client.dll")
#define LOCALIZE_DLL			crypt_str("localize.dll")
#define MATERIALSYSTEM_DLL		crypt_str("materialsystem.dll")
#define VGUI_DLL				crypt_str("vguimatsurface.dll")
#define VGUI2_DLL				crypt_str("vgui2.dll")
#define SHADERPIDX9_DLL			crypt_str("shaderapidx9.dll")
#define GAMEOVERLAYRENDERER_DLL crypt_str("gameoverlayrenderer.dll")
#define PHYSICS_DLL				crypt_str("vphysics.dll")
#define VSTDLIB_DLL				crypt_str("vstdlib.dll")
#define TIER0_DLL				crypt_str("tier0.dll")
#define INPUTSYSTEM_DLL			crypt_str("inputsystem.dll")
#define STUDIORENDER_DLL		crypt_str("studiorender.dll")
#define DATACACHE_DLL			crypt_str("datacache.dll")
#define STEAM_API_DLL			crypt_str("steam_api.dll")
#define MATCHMAKING_DLL			crypt_str("matchmaking.dll")
#define SERVER_DLL				crypt_str("server.dll")
#define SERVERBROWSER_DLL		crypt_str("serverbrowser.dll")
#pragma endregion